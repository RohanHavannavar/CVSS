"""
author:Rohan
Script to compute CVSS score

"""
import time
start=time.time()
#sys module is used to take input from command line argument while executing the script
import sys
#creating dictionaries of all possible values of all metrics
...
#converting the input command line argument or vector to dictionary
vector=sys.argv[1]
res=vector.split('/')
d={}
for i in res:
...
#computing modified exploitability
if(d['PR']=='L' and d['S']=='C'):
